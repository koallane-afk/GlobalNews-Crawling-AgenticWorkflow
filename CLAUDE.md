...
│   ├── sot_manager.py                     (SOT 원자적 읽기/쓰기/검증 — fcntl 파일 잠금, SM-ST1 완료 보호(current_step < total_steps 시 "completed" 거부))
